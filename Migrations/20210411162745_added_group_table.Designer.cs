...
namespace RSSReader.Migrations
{
    ...
    [Migration("20210411162745_added_group_table")]
    partial class added_group_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSSReader.Models.ApiUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RSSReader.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RSSReader.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RSSReader.Models.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RSSReader.Models.ApiUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RSSReader.Models.Subscription", b =>
                {
                    ...
                    b.HasOne("RSSReader.Models.Group", "Group")
                        .WithMany()
