...
namespace ServiceLayer.BlogServices
{
    public class BlogService : IBlogService
    {
        ...
        public BlogService(DataContext context, IHttpHelperService httpService, IMapper mapper)
        {
            _context = context;
        ...
        public async Task<Blog> GetOrCreateBlog(string url)
        {
            ...
            if (blog == null)
            {
                ...
                if (parsed_feed == null)
                {
                    ...
                    http_response = await GetContentUnderUrl(feed_url);
        ...
        private string GetUrlOfFeed(HttpHelperService.HttpCallResponse html)
        {
            try
            {
    ...
    {
        public Task<Blog> GetOrCreateBlog(string url);
    }
}
