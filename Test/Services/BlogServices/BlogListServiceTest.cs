...
namespace Tests.Services.BlogServices
{
    [TestFixture]
    class BlogListServiceTest
    {
        ...
        public async Task GetListAsync_GetsSubsAssignedToUser_ListOfActiveSubs()
        {
            ...
            var service = new BlogListService(MapperHelper.GetNewInstance(), _unitOfWork);
            //ACT
            ...
            Assert.That(result.First().UserData.GroupId, Is.EqualTo(group.Id));
            Assert.That(result.First().Id, Is.EqualTo(blog0.Id));
        }
        ...
        public async Task GetListAsync_GetsSubsAndCountUnreaded_ListOfActiveSubs()
        {
            ...
            //ASSERT
            Assert.That(result.First().UserData.UnreadedCount, Is.EqualTo(2));
        }
    }
}
